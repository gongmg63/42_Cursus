...
OBJS = ft_isalpha.o ft_memcmp.o ft_strdup.o ft_strnstr.o ft_atoi.o ft_isascii.o ft_memcpy.o ft_strlcat.o ft_strrchr.o ft_bzero.o ft_isdigit.o ft_memmove.o ft_strlcpy.o ft_tolower.o ft_calloc.o ft_isprint.o ft_memset.o ft_strlen.o ft_toupper.o ft_isalnum.o ft_memchr.o ft_strchr.o ft_strncmp.o
NAME = libft.a
HEADER = libft.h
